...
def message_info_e():
    mb0 = messagebox.showinfo(
        "showinfo", "e is a prime number and is in the range from 0 to phi(n) ")


def message_info_input():
    mb0 = messagebox.showinfo(
        "showinfo", "1.Character: enter as letters without numbers. 2.Number: Must enter number and must be in the correct format 1 # 2 # 3... with a space between the number and '#' ")
